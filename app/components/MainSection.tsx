const MainSection = () => {
    return (
        <div className="flex flex-col-reverse lg:flex-row-reverse items-center lg:items-start p-5">
            <img src="/next.webp" alt="Next.js" className="w-full max-w-md rounded-lg lg:mr-8" />
            <section className="mt-28 text-center mr-5">
                ...
                <p className="font-medium text-lg mt-3 text-gray-700">
                    Whether you're building small projects or large-scale applications, Next.js gives you the flexibility 
